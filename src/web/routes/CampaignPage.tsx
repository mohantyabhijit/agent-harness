...
type PublicationState = Readonly<{ routeIdentity: object; proposalId: string; status: "submitting" | "unknown" | "reconciled" | "error"; result?: PublicationResult }>;

...
function escalationCopy(reason: CampaignSnapshot["qualityEscalationReason"]): string {
  ...
  return ({ maximum_qodo_iterations: "The durable quality record says the three-iteration Qodo repair limit was reached.", tests_failed: "The durable quality record says verification tests failed.", repair_child_failed: "The durable quality record says the repair session failed.", operation_result_not_safely_recorded: "The durable campaign record could not safely record an operation result.", operator_recovered_interrupted_operation: "An interrupted operation was recovered into human review." } as const)[reason];
}

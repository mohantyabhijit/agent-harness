...
- [ ] **Native chat and product redesign:** tracked in [issue #21](https://github.com/mohantyabhijit/agent-harness/issues/21); make the native TrueForge UI the first screen, remove the blocking local capability gate, adopt a Stripe-like light system, and make verified discovery resilient without weakening evidence validation.
